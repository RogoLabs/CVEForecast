...
class UnifiedForecastPipeline:
    ...
    def __init__(
        ...
        self.cna_forecaster = CNAForecaster(config_path=cna_config, cvelist_dir=cvelist_dir, min_cves=min_cves)

        self.results = {'cve': {}, 'cna': {}}
    ...
    def run_all(
        ...
        self.results = {'cve': cve_results, 'cna': cna_results}
