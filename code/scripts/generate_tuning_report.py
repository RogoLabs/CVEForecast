...
summary_lines = ['# Hyperparameter Tuning Summary', '', f'**Date:** {now}', f'**Status:** {status}', '']
...
status_payload = {'status': status, 'generated_at': dt.datetime.now(dt.timezone.utc).isoformat() + 'Z'}
