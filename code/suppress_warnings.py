...
def suppress_production_warnings():
    ...
    warnings.filterwarnings(
        'ignore', message='X does not have valid feature names', category=UserWarning, module='sklearn'
    )
    ...
    warnings.filterwarnings('ignore', message='.*downcasting.*', category=FutureWarning, module='pandas')
